package com.utilities.techno.blogger.utilities;
...
public class Utils {
    /**
     * Custom EditText Watcher for the Mobile Number Format like (XXX) XXX-XXXX
     *
     * @param edtView, Passing the current editText View.
     */
